...
def build_live_tools(get_doc: Callable[[], dict]) -> ToolRegistry:
    ...
    registry.register(Tool(
        ...
        description=(
            ...
            "ALSO use it for SAFETY: on any hands-on task, register watches for how the work is "
            "actually being done — hand position relative to a blade, grip on a tool, whether a "
            "pan handle projects past the edge, whether a fitting is seated. Ask for the "
            "physical detail ('are the fingertips of the free hand curled back or extended "
            "flat?'), never for a judgement ('is this safe?') — you are the one who judges. "
            "Set priority='high' "
